...
let items = [
    {
        ...
        brief: "Собственное портфолио, разработано специально для демонстрации возможностей фреймворка Claw (Клешня).",
                                    ...
                                    <div class="row g-4">
                                        ...
                                        <div class="col-12">
                                            <div class="swiper-container swiper-demo">
                                                ...
                                                <div class="btn btn-primary btn-icon swiper-button-next" style="width: 2.5rem; height: 2.5rem; --swiper-navigation-color: var(--cl-btn-color);">
                                                    <i class="cl-icon-next"></i>
                                                </div>
                                                <div class="btn btn-primary btn-icon swiper-button-prev" style="width: 2.5rem; height: 2.5rem; --swiper-navigation-color: var(--cl-btn-color);">
                                                    <i class="cl-icon-previous"></i>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="card-body flex-fill">
                            <div class="row g-3">
                                ...
                                <div class="card-image rounded ratio ratio-16x9 lazyload overflow-hidden">
                                    <img data-src="${item.image}" class="lazyload object-fit-cover" />
                                </div>
                                </div>
                                <div class="col-12">
                                    <div class="card-body">
